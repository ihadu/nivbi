...
<div align="center"> <img src="https://gitee.com/oicio/BigData-Notes/raw/master/pictures/kafka-send-messgaes.png"/> </div>
...
> 本篇文章的所有示例代码可以从 Github 上进行下载：[kafka-basis](https://github.com/oicio/BigData-Notes/tree/master/code/Kafka/kafka-basis)
...
<div align="center"> <img src="https://gitee.com/oicio/BigData-Notes/raw/master/pictures/kafka-simple-producer.png"/> </div>
...
public class ProducerWithPartitioner {
    ...
    public static void main(String[] args) {
        ...
        /*传递自定义分区器*/
        props.put("partitioner.class", "com.oicio.producers.partitioners.CustomPartitioner");
        /*传递分区器所需的参数*/
