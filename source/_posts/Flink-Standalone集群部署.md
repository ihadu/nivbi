---
title: Flink-Standalone集群部署
date: 2022-03-19 17:41:35
tags:
- flink
categories:
- 大数据组件
...
Flink 的运行依赖 JAVA 环境，故需要预先安装好 JDK，具体步骤可以参考：[Linux 环境下 JDK 安装](https://github.com/oicio/BigData-Notes/blob/master/notes/installation/Linux下JDK安装.md)
...
<div align="center"> <img src="https://gitee.com/oicio/BigData-Notes/raw/master/pictures/flink-dashboard.png"/> </div>
...
<div align="center"> <img src="https://gitee.com/oicio/BigData-Notes/raw/master/pictures/flink-socket-wordcount.png"/> </div>



也可以通过 WEB 控制台查看到统计结果：

<div align="center"> <img src="https://gitee.com/oicio/BigData-Notes/raw/master/pictures/flink-socket-wordcount-stdout.png"/> </div>
...
<div align="center"> <img src="https://gitee.com/oicio/BigData-Notes/raw/master/pictures/flink-start-cluster-shell.png"/> </div>
...
+ [Hadoop 集群环境搭建](https://github.com/oicio/BigData-Notes/blob/master/notes/installation/Hadoop集群环境搭建.md)
+ [Zookeeper 单机环境和集群环境搭建](https://github.com/oicio/BigData-Notes/blob/master/notes/installation/Zookeeper单机环境和集群环境搭建.md)
...
<div align="center"> <img src="https://gitee.com/oicio/BigData-Notes/raw/master/pictures/flink-standalone-cluster-ha.png"/> </div>



可以看到集群已经以 HA 的模式启动，此时还需要在各个节点上使用 `jps` 命令来查看进程是否启动成功，正常情况如下：

<div align="center"> <img src="https://gitee.com/oicio/BigData-Notes/raw/master/pictures/flink-standalone-cluster-jps.png"/> </div>
...
<div align="center"> <img src="https://gitee.com/oicio/BigData-Notes/raw/master/pictures/flink-optional-components.png"/> </div>
